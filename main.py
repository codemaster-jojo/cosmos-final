...
decoder_model = Decoder(constellation_model)
...
optimizer = optim.Adam(
    list(list(constellation_model.parameters())),
    lr=0.001,
)
...
data_distrb, loss_over_time = trainer(dataloader, constellation_model, decoder_model, noise_model, optimizer, loss_function, max_steps=5000, report_every=500)
